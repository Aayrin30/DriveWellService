    ...
    <>
      ...
      <section class="background firstsection">
          <div class="secondhalf">
            <center>  <p class="text-big animated-text" >Expert Technitians,Competitive Prices</p>
              <p class="text-small animated-text">We are commited to earning your trust by providing the expertise and value you expect</p>
              <Link to="/about">
                <button type="button" class="btnn btnn-sm btnn-text">MORE</button>
              </Link>
            </center>
          </div>
           <div class="firsthalf">
      ...
      <section className='secondsection'>
        <div className="main">
          ...
          <div className="why">
            ...
            <p>We are one of the leading auto repair shops serving customers in Ahmedabad.<br />
              All mechanic services are performed by highly qualified mechanics</p>
          </div>
          <div className="mainimg">
            <div className='imageclass1 imgclass'>
              <img src='service.png' alt="img1" />
              <h1>Best Material</h1>
            ...
            <div className='imageclass2 imgclass' >
              <img src='tow-truck.png' alt="img2" />
            ...
            <div className='imageclass3 imgclass'>
              <img src='video-conference.png' alt="img3" />
      ...
      <section className="thirdsection">
        <div className="our">
          ...
          <p>We offer a full range of garage services to vehicle owners located in our area.<br />
          ...
          <div className="uppercontainer">
            <div className="overview">
              ...
              <div className="overviewdetail">
                ...
                <p>, our car audio service is designed to elevate your driving experience to new heights.
                   Whether you're a music aficionado or a podcast enthusiast,we've got you covered.</p>
              </div>
            </div>
            <div className="overview">
              ...
              <div className="overviewdetail">
                ...
                <p>As part of our commitment to providing comprehensive automotive care, we are proud to offer a complimentary oil change service to all our valued customers.</p>
              </div>
            </div>
            <div className="overview">
              ...
              <div className="overviewdetail">
                ...
                <p>Our state-of-the-art diagnostic equipment and skilled technicians enable us to quickly and accurately assess the health of your engine, identifying any potential issues or areas of concern.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lowercontainer">
            <div className="overview">
              ...
              <div className="overviewdetail">
                ...
                <p>Our expert technicians specialize in diagnosing and servicing automotive air conditioning systems to ensure optimal performance and reliability.</p>
              </div>
            </div>
            <div className="overview">
              ...
              <div className="overviewdetail">
                ...
                <p>Your car's battery is its lifeline.Keep your vehicle powered up and running smoothly with the professional car battery repair service at DriveWellService.</p>
              </div>
            </div>
            <div className="overview">
              ...
              <div className="overviewdetail">
               ...
               <p>Ensure your vehicle's safety and performance.Modern vehicles are equipped with an array of sensors that play a crucial role in monitoring and ensuring optimal performance.</p>
              </div>
            </div>
          </div>
        </div>
